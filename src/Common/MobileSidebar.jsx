...
const MobileSidebar = ({setOpenSidebar,openSideBar}) => {
  return (
    <div className='h-screen bg-green-200'>
     <div className={`w-64 z-40 absolute bg-green-200 shadow md:h-full flex-col justify-between lg:hidden transition duration-150 ease-in-out ${openSideBar ? 'translate-x-0': 'translate-x-[-260px]'}`} id="mobile-nav">
                        <button onClick={()=>setOpenSidebar(true)} aria-label="toggle sidebar" id="openSideBar" className={`h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 rounded focus:ring-gray-800 ${openSideBar? 'hidden':'block'}`} >
                        ...
                        onClick={()=>setOpenSidebar(false)}
                         className={`
                        h-10 w-10 bg-gray-800  absolute right-0 mt-16 -mr-10  items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white ${openSideBar?'flex':'hidden'}`} >
                        ...
                        <div className="px-6">
                            <div className="h-16 pl-3 w-full flex items-center">
                           ...
                           <DashboardMenu/>
                            <div className="flex justify-center invisible mt-48 mb-4 w-full">
                                <div className="relative">
                                    ...
                                    <input className=" focus:outline-none focus:ring-1 focus:ring-gray-100  rounded w-full text-sm text-gray-300 placeholder-gray-400 pl-10 py-2" type="text" placeholder="Search" />
                                </div>
                            </div>
                        </div>
