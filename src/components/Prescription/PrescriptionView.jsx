...
const PrescriptionView = ({setDate,setImage,setPage,page,handleSubmit}) => {
          ...
          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <td className=" py-4">
              <p className=" text-[#499AFA] flex items-center  dark:text-blue-500 hover:underline">
               <AiFillEye className="hover:text-red-400 cursor-pointer" size={23}/> <AiOutlineDownload className="ml-1 cursor-pointer hover:text-red-400" size={23}/>
              </p>
            </td>
          </tr>
        </>
      ...
      <div className="mt-10">
        ...
        <div className="  py-3 flex  items-center content-center justify-between">
         ...
         required={true} onChange={(e)=>{setDate(e.target.value)}}
          type='date' className="max-w-[250px] border-1 focus:border-gray-300 outline-none  focus:ring-0 rounded-md mr-2"
         
          />
          <PrimaryButton handleSubmit={handleSubmit} type={'button'} isBg={'!bg-gray-700 '}>Add</PrimaryButton>
          </span>
        </div>
