...
export const doctorHeading = [
  "Patient Name",
  "Date",
  "Time",
];
export const doctorPastHeading = [
  "Patient Name",
  "Date",
  "Time",
  "Prescription",
...
export const patientUpComingHeading = [
  "Doctor Name",
  "Date",
  "Time"
];
...
export const location = [
  { id: 1, value: "mSmart Hospital,jaipur" },
  "mSmart Hospital,Delhi",
  "mSmart Hospital,Delhi",
  "mSmart Hospital,Gurugram",
];
...
export const department = [
  {
    name: "Audiologist",
    description:
      "As the name suggests, an audiologist treats and evaluates anything and everything to do with audio or hearing abilities of a person. Since hearing is a very important sense, it requires an expert to treat the same",
  },
  {
    name: "Dentist",
    description:
  ...
  },
  {
    name: "Gynaecologist",
    description:
      "A gynaecologist is trained to treat the female reproductive system which includes the vagina, uterus, ovaries and breasts.",
  },
  {
    name: "Orthopaedic surgeon",
    description:
      "An orthopaedic surgeon is known to deal with issues relating to the musculoskeletal system. This means muscles and bones. Any fracture, pain or abnormality of these areas need to be consulted about with an orthopaedic surgeon.",
  },
  {
    name: "Paediatrician",
    description:
      "Paediatricians are doctors who treat children. Since a child’s body functions in a different manner from ours, due to many factors like age and growing stages, their illness and health issues are different from an adult. ",
  },
  {
    name: "Psychiatrists",
    description:
  ...
  },
  {
    name: "Veterinarian",
    description:
      "After the uniqueness of mental health, comes the issue of our furr buddies: animals. Treatment and diagnosis of issues in animals is done by a veterinarian. This includes mental and physical both as well.",
  },
  {
    name: "Radiologist",
    description:
      "A radiologist for diagnosing diseases and internal & external injuries with the help of imaging techniques like x-rays, CT scan, MRI and ultrasound etc. They are the first step towards the diagnosis of any sort, which cannot be done without a machine.",
  },
  {
    name: "Nephrology",
    description: "",
